...
<header class="header">
    <div class="header__topbar">
        <div style="background-color: black;" class="container p-relative d-flex space-between align-center">
            ...
            <div class="header__container d-grid middle-left">
                ...
                <div class="header__logo d-flex justify-center align-center">
                    <a href="index.php" class="d-inline-block">
                        <img class="d-block w-100 svg__icon" src="./assets/images/logo/gentcare_logo.svg" alt="Logo" />
                    </a>
                </div>
