                ...
                <div class="col" style="--w-md: 4">
                    <div class="footer__block pd-top">
                        ...
                        <ul class="block__list">
                            ...
                            ?>
                                <li class="block__item"><a class="footer__anchor" href="index.php?page=products&brand_id=<?php echo $row_brand['brand_id'] ?>"><?php echo $row_brand['brand_name'] ?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <p class="footer__copy--right">GentCare2025</p>
                    </div>
                </div>
            </div>
        </div>
